...
if(!empty($_POST)){
    ...
    $resultados = mysqli_query($db_conexion,"SELECT r.RutaId,t.IdRuta,r.Fecha,r.Hora,r.AsientoCop,r.AsientoIzq,r.AsientoCen,r.AsientoDer FROM ruta as r inner join tiquetes as t ON t.IdRuta = r.RutaId WHERE r.AsientoCop='Disponible' OR r.AsientoIzq='Disponible' OR r.AsientoCen='Disponible' OR r.AsientoDer='Disponible';");
  ...
  <div class="container ">
    ...
    ?>
        ...
        <div class = "container">
            ...
            <form class="container" action="../Envios/ModificarRuta.php" method="post">
                <div class="container ">
                    ...
                    <div class="container d-flex align-items-center" style = "height: auto; width: auto">
                        ...
                        <div class="m-3">
                            ...
                            <input type="text" name="txt_rutaId" id="txt_rutaId" class="form-control-sm" Required readonly value="<?php echo $datos['RutaId']; ?>">
                        </div>
                        <div class="m-3">
                    ...
                    <div class="container d-flex align-items-center " style = "height: auto; width: auto">
                      <div class="m-3">
                        ...
                        <input type="date" name="txt_fechaViaje" id="txt_fechaViaje" class="form-control-sm" placeholder="aaaa-mm-dd" Required readonly value="<?php echo $datos['Fecha']; ?>">
                       </div>
                        <div class="m-3">
                            <div><label for="lbl_hora" class="form-label"><b>Hora Del Viaje</b></label></div>
                            <input type="time" name="txt_hora" id="txt_hora" class="form-control-sm" placeholder="Apellido1" Required readonly value="<?php echo $datos['Hora']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="container d-flex align-items-center mb-3" style = "height: auto; width: auto">
                      <div class="m-3">
                        ...
                        <select class="form-control-sm border-dark" type="form-select" name="drop_asiento" id="drop_asiento" Required>
                            ...
                            <?php if($datos['AsientoCop']=='No Disponible'){ ?>
                                <option value=1><?php echo"Ocupado" ?></option>
                            <?php }else{ ?>
                                <option value=1>Copiloto</option>
                            <?php } ?>
                            <?php if($datos['AsientoIzq']=='No Disponible'){ ?>
                                <option value=2><?php echo"Ocupado" ?></option>
                            <?php }else{ ?>
                                <option value=2>Izquierdo</option>
                            <?php } ?>
                            <?php if($datos['AsientoCen']=='No Disponible'){ ?>
                                <option value=3><?php echo"Ocupado" ?></option>
                            <?php }else{ ?>
                                <option value=3>Central</option>
                            <?php } ?>
                            <?php if($datos['AsientoDer']=='No Disponible'){ ?>
                                <option value=4><?php echo"Ocupado" ?></option>
                            <?php }else{ ?>
