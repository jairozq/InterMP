  ...
  <div class="navbar container-fluid justify-content-center align-items-center" style = "height: auto; width: auto">
    <tbody>
      <div class="container justify-content-center d-flex align-items-center" style = "height: auto; width: auto">
        <li class="nav-item">
          <a class="nav-link border rounded-4 text-center m-5 border-success border-4" style = "height: 240px; width: 260px" href="RealizarReservacion.php">
            <img class="img-center mt-4 mb-3" src="../../Imagenes/IconoCrearReserva.png" alt="LogoINTERMP" width="auto" height="150px">
            <pre><h7 class="border rounded-5 border-dark border-2"> Crear Reservación <h7></pre>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link border rounded-4 text-center m-5 border-success border-4" style = "height: 240px; width: 260px" href="EscogerViajesProgramados.php">
            <img class="img-center mt-4 mb-3" src="../../Imagenes/IconoBusqueda.png" alt="LogoINTERMP" width="auto" height="150px">
            <pre><h7 class="border rounded-5 border-dark border-2"> Escoger una Reservación <h7></pre>
          </a>
        </li>
      </div>
    </tbody>
