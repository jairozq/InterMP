...
<header>
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark border-5 border-bottom border-success">
    <div class="container-fluid">
      ...
      <form class="d-flex" action="../Envios/BuscarRuta.php" method="post">
        <input class="form-control me-2" type="search" name="txt_consulta" id="txt_consulta" placeholder="Buscar ID..." aria-label="Search">
