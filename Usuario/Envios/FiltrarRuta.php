...
<body>
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark border-5 border-bottom border-success">
      ...
      <a class="navbar-brand" href="#">
        ...
        <form class="d-flex" action="BuscarRuta.php" method="post">
            <input class="form-control me-2" type="search-number" name="txt_consulta" id="txt_consulta" placeholder="Buscar ID de Ruta..." aria-label="Search">
    ...
    <form class="m-2 d-flex" action="../Menu/SeleccionarViaje.php" method="post">
    <div class="col-auto">
  ...
  <div class = "container">
    ...
    <div class="table-responsive">
      <table class="table table-striped table-hover table-borderless table-primary align-middle">
        ...
        <tbody id="tbl-RutasResultado">
          <?php
            include("../../Conexion.php");
            $db_conexion = mysqli_connect($db_host,$db_usr,$db_pass,$db_nombre);
            $txt_consulta = $_POST["txt_consulta"];
            $db_conexion ->real_query("SELECT * FROM ruta where AsientoCop='Disponible' OR AsientoIzq='Disponible' OR AsientoCen='Disponible' OR AsientoDer='Disponible' AND RutaId='". $txt_consulta ."';");
  ...
  <script>
    $("#tbl-RutasResultado").on('click','tr td',function(e){
      var target,RutaId;
      target = $(event.target);
