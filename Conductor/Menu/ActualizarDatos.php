  ...
  <header>
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark border-5 border-bottom border-success">
      ...
      <?php
        ...
        $_SESSION['guardado']=$_SESSION['guardado'];
      ?>
      <!--icono-->
  ...
  <div class="container mt-3">
    ...
    <div class = "container">
      ...
      <form class="container" action="../Envios/EnviarDatos.php" method="post">
        ...
        <?php
        //crear un texto que identifique cada error
        if($_SESSION['guardado']==true){
          echo "<h6 class='text-succes'><b>Guartado correctamente</b>   </h6>";
